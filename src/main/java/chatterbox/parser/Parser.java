...
public class Parser {
    ...
    public static String parse(String userInput, TaskList tasks, Ui ui, Storage storage) throws ChatterBoxException {
        ...
        switch (userinput) {
            ...
            default:
                return handleDefault(userInput, tasks, ui);
        }
    }
    ...
    private static String handleTodo(String userInput, TaskList tasks, Storage storage, Ui ui) throws ChatterBoxException{
    ...
    private static String handleDeadline(String userInput, TaskList tasks, Storage storage, Ui ui) throws ChatterBoxException{
    ...
    private static String handleEvent(String userInput, TaskList tasks, Storage storage, Ui ui) throws ChatterBoxException{
