        ...
        while (chatting) {
            if (scanner.hasNextLine()) { // Add this check
                ...
                if (userInput.equalsIgnoreCase("bye")) {
                    ...
                    String task = userInput.substring(userInput.indexOf(" ") + 1); // generated by github copilot to get
                                                                                   // the
                                                                                   // task description
                    ...
                    String taskAndAt = firstPart.substring(firstPart.indexOf(" ") + 1); // generated by github copilot
                                                                                        // to
